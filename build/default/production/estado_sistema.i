...
# 2 "estado_sistema.c" 2

# 1 "./bits.h" 1
# 3 "estado_sistema.c" 2
...
void kpInit(void);
# 7 "estado_sistema.c" 2


void emergencia(void) {

    unsigned char i, j, k;
    unsigned char msg[] = "ALERTA FALHA NO SISTEMA";
    for (k = 0; k < 7; k++) {
        lcdData(msg[k]);
    }
    lcdCommand(0xC0);
...
unsigned char inicializacao(void) {
    static unsigned char senha[] = "123456";
    static unsigned char msg[] = "tente novamente";
    static unsigned char msg_2[] = "digite a senha";
    static unsigned char digito, j, i, cont = 0;
    static unsigned char entrada[6];
